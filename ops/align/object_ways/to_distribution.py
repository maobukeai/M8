...
from .to_matrix import rotation_to_matrix, location_to_matrix, scale_to_matrix
    ...
    def align_to_distribution(self, context):
        ...
        if self.distribution_mode == "FIXED":
            for item in items:
                ...
                loc = location_to_matrix(self.__mix_two_loc__(offset - item.min_bound_box_point, obj.location))
            ...
            for (orientation, offset, items) in (
                ...
                for item in items:
                    ...
                    loc = location_to_matrix(self.__mix_two_loc__(loc_a, obj.location))
